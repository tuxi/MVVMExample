...
- (void)xy_config:(UITableViewCell *)cell model:(id)model indexPath:(NSIndexPath *)indexPath {
    ...
    ThirdDynamicItem *item = (ThirdDynamicItem *)model;
    _item = item;
...
/// 计算picContent的高度
- (CGFloat)calculatePicContentHeight:(ThirdDynamicItem *)item indexPath:(NSIndexPath *)indexPath {
...
/// 计算评论的高度
- (CGFloat)calculateCommentContentH:(ThirdDynamicItem *)item {
